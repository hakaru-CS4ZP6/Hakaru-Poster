...
\bigskip
\scriptsize{Consider a continuous random variable, \textit{X}, that is distributed by a normal distribution. This is denoted by: }
...
\bigskip
\scriptsize{Below is a graph of the probability density function (PDF) for the standard normal distribution. It describes the probability that a sample of the random variable X will be equal to $x$ \in \R.}
...
\begin{figure}[!tbp]
  \centering
  \subfloat[]{ \includegraphics[width=0.45\textwidth]{cauchy.png}\label{fig:f1}}
  \subfloat[]{ \includegraphics[width=0.45\textwidth]{cauchy_2.png}\label{fig:f2}}
